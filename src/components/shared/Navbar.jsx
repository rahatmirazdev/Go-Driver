    ...
    >
      <div className="container mx-auto px-4 py-6 flex justify-between items-center">
        <div className="flex items-center">
          <span className="text-xl font-bold text-soft-green">GoDriver</span>
        </div>
        ...
        <nav className={`z-50 md:flex md:items-center ${isOpen ? "absolute top-16 left-0 w-full bg-white shadow-md" : "hidden"}`}>
